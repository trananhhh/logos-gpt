    ...
    <>
      ...
      <div className="flex items-center justify-end">
        <button
          ...
          type="button"
        >
          {updateAgentAction.isLoading && <Spinner className="icon-md" />}
          {!updateAgentAction.isLoading && action?.action_id && localize('com_ui_update')}
          {!updateAgentAction.isLoading && !action?.action_id && localize('com_ui_create')}
        </button>
      </div>
    </>
  );
